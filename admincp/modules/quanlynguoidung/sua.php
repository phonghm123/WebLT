...
?>
<div class="container" style="margin-bottom: 20px; border-bottom: 2px solid black;font-family: 'Times New Roman', Times, serif;font-size: 20px">
...
<form action="modules/quanlynguoidung/xuly.php?idnguoidung=<?php echo $_GET['idnguoidung'] ?>" method="POST" enctype="multipart/form-data">
	...
	<br>
	Address
	<textarea class="form-control" name="diachis"><?php echo $nguoidung['diachi']?></textarea>
	<br>
	Chức Vụ 
