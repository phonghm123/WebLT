...
<body>
<ul class="admincp_list" style="font-family: 'Times New Roman', Times, serif;">
<li><a class="btn btn-primary" href="../index.php">Quay về trang chủ</a></li>
    <li><a class="btn btn-primary" href="index.php?action=quanlysanpham&query=them">Quản lý sản phẩm </a></li>

    <?php
        if(isset($_SESSION['dangnhap'])){
            if($_SESSION['dangnhap']=='admin'){
    ?>
        <li><a class="btn btn-primary" href="index.php?action=quanlydanhmucsanpham&query=them">Quản lý danh mục sản phẩm </a></li>
